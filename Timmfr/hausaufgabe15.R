...
# Antwort: Die R^2 und t-Werte sind gleich, jedoch unterscheiden sich die Koeffizienten. 
...
#Ant wort: Der Datensatz women hatte eine größere und homogenere Menge an Teilnehmern,
# im Gegensatz zu dem der Kursteilnehmer.